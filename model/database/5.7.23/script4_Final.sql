...
CREATE TABLE IF NOT EXISTS `findesk`.`item` (
  ...
  `fotoItem` VARCHAR(80) NULL DEFAULT NULL COMMENT 'Atributo referente ao arquivo de imagem do item',
...
INSERT INTO `findesk`.`cor` (`idCor`, `nomeCor`) VALUES ('#999999', 'Nulo');
...
INSERT INTO `findesk`.`ano` (`idAno`) VALUES (0);
...
INSERT INTO `findesk`.`dia` (`idDia`) VALUES (0);
...
INSERT INTO `findesk`.`mes` (`idMes`) VALUES (0);
...
INSERT INTO `findesk`.`data` (`idData`, `idDia`, `idMes`, `idAno`) VALUES (0, 0, 0, 0);
...
START TRANSACTION;
USE `findesk`;
INSERT INTO `findesk`.`dataSaida` (`idDataSaida`, `idData`) VALUES (0, 0);
...
INSERT INTO `findesk`.`documento` (`idDoc`, `nomeDoc`) VALUES (0, 'Nulo');
...
START TRANSACTION;
USE `findesk`;
INSERT INTO `findesk`.`item` (`idItem`, `idCor`, `idDoc`, `idNome`, `idAdm`, `idDataEntrada`, `idDataSaida`, `retiradoItem`, `fotoItem`, `descricaoItem`) VALUES (1, '#000000', 0, '1', 1, 1, 1, 1, 'C:\\Users\\victo\\Desktop\\Findesk\\findesk.cliente\\src\\view\\images\\pendrive', 'Lindo pendrive ');
INSERT INTO `findesk`.`item` (`idItem`, `idCor`, `idDoc`, `idNome`, `idAdm`, `idDataEntrada`, `idDataSaida`, `retiradoItem`, `fotoItem`, `descricaoItem`) VALUES (2, '#000000', 0, '2', 1, 2, 2, 0, 'C:\\Users\\victo\\Desktop\\Findesk\\findesk.cliente\\src\\view\\images\\notebook', 'Lindo notebook');
INSERT INTO `findesk`.`item` (`idItem`, `idCor`, `idDoc`, `idNome`, `idAdm`, `idDataEntrada`, `idDataSaida`, `retiradoItem`, `fotoItem`, `descricaoItem`) VALUES (3, '#FFFFFF', 0, '3', 1, 1, 1, 0, NULL, 'Camisa G via lance');
INSERT INTO `findesk`.`item` (`idItem`, `idCor`, `idDoc`, `idNome`, `idAdm`, `idDataEntrada`, `idDataSaida`, `retiradoItem`, `fotoItem`, `descricaoItem`) VALUES (4, '#0000FF', 0, '4', 1, 1, 1, 0, 'C:\\Users\\victo\\Desktop\\Findesk\\findesk.cliente\\src\\view\\images\\caderno', 'Caderno 10 matérias da Moranguinho');
INSERT INTO `findesk`.`item` (`idItem`, `idCor`, `idDoc`, `idNome`, `idAdm`, `idDataEntrada`, `idDataSaida`, `retiradoItem`, `fotoItem`, `descricaoItem`) VALUES (5, '#0000FF', 0, '5', 1, 1, 1, 0, NULL, 'Caneta BIC ');
INSERT INTO `findesk`.`item` (`idItem`, `idCor`, `idDoc`, `idNome`, `idAdm`, `idDataEntrada`, `idDataSaida`, `retiradoItem`, `fotoItem`, `descricaoItem`) VALUES (6, '#00FF00', 0, '6', 1, 1, 1, 1, NULL, 'Garrafa de aluminio');
INSERT INTO `findesk`.`item` (`idItem`, `idCor`, `idDoc`, `idNome`, `idAdm`, `idDataEntrada`, `idDataSaida`, `retiradoItem`, `fotoItem`, `descricaoItem`) VALUES (8, '#999999', 1914413, '7', 1, 1, 1, 0, NULL, 'RA');
INSERT INTO `findesk`.`item` (`idItem`, `idCor`, `idDoc`, `idNome`, `idAdm`, `idDataEntrada`, `idDataSaida`, `retiradoItem`, `fotoItem`, `descricaoItem`) VALUES (7, '#000000', 0, '8', 1, 1, 1, 1, 'C:\\Users\\victo\\Desktop\\Findesk\\findesk.cliente\\src\\view\\images\\guardachuva', 'Guarda chuva grande');
...
CREATE PROCEDURE fill_date_dimension(ano int)
BEGIN
